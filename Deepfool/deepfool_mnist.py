...
'''
#-------------------------------------------------------------------------------
print('画出对抗样本的 1.输出最大概率分布 2.输出概率分布差值')
...
plt.title("Difference of the highest two probabilities in adversarial examples - deepfool")
plt.hist(adv_pro)

print("在初始样本上的最大概率：",clean_pro)
plt.figure(2,figsize=(10, 10))
#plt.title("Original examples output frequency")
plt.title("Difference of the highest two probabilities in original examples - deepfool")
plt.hist(clean_pro)
'''
print("在对抗样本上的最大概率：",adv_pro)
plt.figure(1,figsize=(10, 10))
plt.title("Output variance of adversarial examples - deepfool")
plt.hist(adv_pro)

print("在初始样本上的最大概率：",clean_pro)
plt.figure(2,figsize=(10, 10))
#plt.title("Original examples output frequency")
plt.title("Output variance of original examples - deepfool")
plt.hist(clean_pro)
