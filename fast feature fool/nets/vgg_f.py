...
def vggf(input):
    ...
    weights_path = os.path.join('weights', 'vgg_f.npy')
    print(weights_path)
    if not os.path.isfile(weights_path):
        print('Downloading VGG-F weights...')
        urlretrieve ("https://www.dropbox.com/s/b96tfz2hnthfegm/vgg_f.npy?raw=1", os.path.join('weights', 'vggf.npy'))
